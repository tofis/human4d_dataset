...
data_path = 'E:/VCL/Users/tofis/Data/DATASETS/RGBDIRD_MOCAP_DATASET/Data/Recordings/_ird_recordings'
# subjects = [x for x in os.listdir(data_path) if x.startswith('S')]
subjects = ['S1', 'S2', 'S3', 'S4']

with open(os.path.join(data_path, 'metadata_single_ir.txt')) as metadata_file:
